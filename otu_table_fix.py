...
#first include some color text class variables (purely bells and whistles)
class colors:
	COMPLETE = '\033[92m'
...
print colors.COMPLETE + "Complete, collapsed OTU table written to: collapsed_otu_table.txt" #tell the user that it's done!
